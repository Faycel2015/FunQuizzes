package com.mobiosdev.funquizzes;
...
public class Constant {
    ...
    public static String QUIZ_URL = "https://mobiosdev.com/Quizzes/api-v2.php";  //api url
    public static String FIREBASE_URL = "https://funquizzes-3f75f-default-rtdb.firebaseio.com/";/*FireBase function URL*/
    /////// PARAMETERS  ///////
